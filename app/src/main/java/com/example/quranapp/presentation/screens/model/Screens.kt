package com.example.quranapp.presentation.screens.model
...
sealed class Screens(@StringRes internal val screenName: Int): NavKey{
    ...
    @Serializable
    data class QuranPlaylistScreen(val metaData: ReciterMetaData): Screens(R.string.quran_playlist_screen)
